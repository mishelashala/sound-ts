...
Thin editor support for the **sound-ts** dialect:
...
- Command **Sound TS: Transform brand type (run CLI)** — shells out to `sts` / `packages/cli`
...
1. Clone [mishelashala/sound-ts](https://github.com/mishelashala/sound-ts)
